...
function Ve({
  ...
  const y = de(t), E = (0, import_react.useMemo)(
  ...
  const he = (0, import_react.useMemo)(() => {
    ...
    if (n > 0 && b > 0)
      for (let V = M; V <= _; V++) {
        ...
        B.push(
          (0, import_jsx_runtime.jsx)("div", { role: "row", "aria-rowindex": V + 1, children: D }, V)
        );
      }
    return B;
  }, [
...
function Ae({
  ...
  const w = de(d), I = (0, import_react.useMemo)(
    () => (0, import_react.memo)(f, ue),
    [f]
  ), [x, m] = (0, import_react.useState)(null), y = ze(c), E = (0, import_react.useMemo)(() => y ? (v) => c.getRowHeight(v) ?? c.getAverageRowHeight() : c, [y, c]), {
    getCellBounds: h,
    getEstimatedSize: z,
    scrollToIndex: k,
  ...
  (0, import_react.useImperativeHandle)(
    ...
    () => ({
      ...
      scrollToRow({
        ...
        const M = k({
          align: v,
          containerScrollOffset: (x == null ? void 0 : x.scrollTop) ?? 0,
          index: A
        });
        typeof (x == null ? void 0 : x.scrollTo) == "function" && x.scrollTo({
          behavior: g,
          top: M
        });
      }
